...
<?php } elseif ($url_cek == 'accounting/bank/') { ?>
    ...
    if(msg){
        ...
        $(document).on('click','.approve-manager', function(){
            let id = $(this).data('id');
            let tipe = $(this).data('tipe');

            $.ajax({
                url: '<?= site_url('pemasukan/approve_manager'); ?>',
                data: {id: id, tipe: tipe},
                type: 'POST',
                dataType: 'JSON',
                success: function(d){
...
<?php } elseif ($url_cek == 'kpr/rek_bank/') { ?>
    <script>
        ...
        $(document).on('click', '.del-rekening', function(e){
            e.preventDefault();
...
<?php } elseif ($url_cek == 'kpr/berkas_konsumen/') { ?>
    ...
    <script>
        ...
        $(document).on('click', '.view-berkas', function(){
            var id = $(this).data('id');
...
<?php } elseif ($url_cek == 'master/cluster/') { ?>
    ...
    <script>
        ...
        $('#btn_submit').click(function(){
            let perum = $('#perum_select').val();
            let cluster = $('#cluster').val();
            let action = $('#formCluster').attr('action');
            ...
            $.ajax({
                url: action,
                data: {perum: perum, cluster: cluster},
                type: 'POST',
                dataType: 'JSON',
                success: function(d){
                    if(d.success == true){
        ...
        $(document).on('click', '.del-cluster', function(e){
            e.preventDefault();
            var link = $(this).attr('href');
        ...
        $('#to_save').click(function(){
            let id = $('#id_cluster_edit').val();
            let perum = $('#id_perum_edit').val();
            let cluster = $('#cluster_edit').val();


            $.ajax({
                url: '<?= site_url('master/edit_cluster') ?>',
                data: {
                    id: id,
                    perum: perum,
                    cluster: cluster
