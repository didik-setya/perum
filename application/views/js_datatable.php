...
if($url_cek == 'inventaris/daftar_barang/'){
    ...
    ?>
        <script type="text/javascript">
            ...
            $(document).on('click', '.del-RABMaterial', function(){
                var id = $(this).data('id');
            ...
            $(document).on('click', '.del-RABUpah', function(){
                var id = $(this).data('id');
            ...
            $(document).on('click', '.del-RABLainnya', function(){
                var id = $(this).data('id');
    ...
    $('#filter').change(function(){
        ...
        if(fil == ''){
            ...
            // } else {
                window.location.href = '<?= site_url('proyek/pengajuan_material?filter=') ?>' + fil + '&status='+ status;
            // }
        }
    });

    $('#fil_stat').change(function(){
        let filter = $(this).val();
        let proyek = $('#filter').val();
        if(filter == ''){
            window.location.href = '<?= site_url('proyek/pengajuan_material') ?>';
        } else {
            // window.location.href = '<?= site_url('proyek/pengajuan_material?status=') ?>' + filter;
            window.location.href = '<?= site_url('proyek/pengajuan_material?filter=') ?>' + proyek + '&status='+ filter;
    ...
    ?>
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $('#id_proyek').change(function(){ 
                    ...
                    $('#kategori_id').html('');
                    $('#total').val('');
                    $('#id_proyek_material').val('');
                    $('#material').html('');
                    $('#id').val('');
                    $('#jumlah').val('');
                    $('#max_out').val('');
                    $('#satuan').val('');
                    $('#showMaxPengajuan').html('');
                    $('#kavling').html('');
                            ...
                            success: function(data){ 
                                ...
                                $.ajax({
                                    ...
                                    success: function(d){
                                        ...
                                        let stok_qty = qty_rab - jml_out - d.total_pengajuan - d.jml_list;
        ...
        jQuery(document).ready(function() {
            ...
            $('#addfrom').click(function(){
                ...
                $('#jenis_material_stok').html('<option value="">--Pilih--</option>');
                $('#material_stok').html('<option value="">--Pilih--</option>');
                $('#jml_pengajuan_stok').val('');
                $('#satuan_material_stok').val('');
            ...
            $(document).on('click', '.delete-data', function(){
                ...
                Swal.fire({
                title: 'Apakah anda yakin?',
                text: 'untuk mengahpus data ini secara permanen?',
                showDenyButton: true,
                showCancelButton: true,
                ...
                /* Read more about isConfirmed, isDenied below */
                    if (result.value) {
                        ...
                        $.ajax({
                            url: '<?= site_url('logistik/delete_data_ajukan_material') ?>',
                            data: {id: id},
                            type: 'POST',
                            dataType: 'JSON',
                            success: function(d){
            ...
            function showSisaStok(){
                    var id=$('#material').val();
                    var id_pro=$('#id_proyek_material').val();
                    let tipe = $('#id_tipe').val();

                    if(id == null || id_pro == null){
                        return true;
                    } else {
            ...
            $('#jenis_material_stok').change(function(){
                ...
                let tipe = $('#id_tipe').val();
                        ...
                        $.ajax({
                            ...
                            success: function(data){ 
                                ...
                                $('#id_material_gudang').val(data.id_pro_mat);

                                let qty_rab = data.quantity;
                                let jml_out = data.jml_out;

                                // $("#jumlah").attr("max", data.quantity).val();
                                $('#satuan_material_stok').val(data.nama_satuan);
                                ...
                                $.ajax({
                                    ...
                                    success: function(d){
                                        ...
                                        $.ajax({
                                            url: '<?= site_url('logistik/get_stok_logistik') ?>',
                                            data: { id_material: id , total: stok_qty},
                                            type: 'POST',
                                            dataType: 'JSON',
                                            success: function(d){
                                               
                                                    $('#jml_pengajuan_stok').val(d.jml_stok);
                                                    $('#showMaxGudang').html('Max pengajuan : ' + d.jml_stok);
                                                    $('#max_out_gudang').val(d.jml_stok);
                                            }
                                        });
            ...
            $('#addFromGudang').click(function(){
                $('#addFromGudang').attr('disabled', true);
                let proyek = $('#id_proyek').val();
                let tipe = $('#id_tipe').val();
                let material = $('#material_stok').val();
                let jml = $('#jml_pengajuan_stok').val();
                let max_out = $('#max_out_gudang').val();
                let rab_material = $('#id_material_gudang').val();

                $.ajax({
                    url: '<?= site_url('logistik/addFromGudang') ?>',
                    data: {
                        proyek: proyek,
                        tipe: tipe,
                        material: material,
                        jml: jml,
                        max_out: max_out,
                        rab_material: rab_material
                    },
                    type: 'POST',
                    dataType: 'JSON',
                    success: function(d){
                        console.log(d);
                        $('#addFromGudang').removeAttr('disabled');
                        load_list_item();
                        if(d.success == true){
                            $('#addFromOther').modal('hide');
                        } else {
...
<?php }elseif($url_cek == 'marketing/data_konsumen/'){ ?>
    ...
    <script>
        ...
        $('#filter').change(function(){
            ...
            if(filter == 0){
                document.location.href = '<?= site_url('marketing/data_konsumen'); ?>';
            } else {
                document.location.href = '<?= site_url('marketing/data_konsumen?filter='); ?>'+filter;
            }
        });
    ...
    //Add data
        $(document).on('click', '#add_calon_konsumen', function(){
            ...
            $('#add_calon_konsumen').attr('disabled', true);
            $('#add_calon_konsumen').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
            ...
            $.ajax({
                ...
                success: function(result){
                    if(result.success == true) {
                        ...
                        $('#add_calon_konsumen').removeAttr('disabled');
                        $('#add_calon_konsumen').html('Save');
        ...
        $('#edit_calon_konsumen').on('click', function(){
            ...
            $('#edit_calon_konsumen').attr('disabled', true);
            $('#edit_calon_konsumen').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
            ...
            $.ajax({
                ...
                success: function(result){
                    if(result.success == true) {
                        ...
                        $('#edit_calon_konsumen').removeAttr('disabled');
                        $('#edit_calon_konsumen').html('Save');
        ...
        $(document).on('click', '.del-calon-konsumen', function(){
            ...
            Swal.fire({
                title: 'Apakah anda yakin?',
                text: "Untuk menghapus konsumen ini?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
...
<?php }elseif($url_cek == 'master/material/'){ ?>
    ...
    $(document).on('click', '.edit-material-act', function(){
        var id = $(this).data('id');
        $.ajax({
...
<?php }elseif($url_cek == 'master/supplier/'){ ?>
    ...
    $(document).on('click', '#add-sup', function(){
        var nama                    = $('#nama').val()
    ...
    $(document).on('click', '.edit-sub-act', function(){
        var id = $(this).data('id');
        $.ajax({
...
<?php }elseif($url_cek == 'master/unit/'){ ?>
    ...
    $(document).on('click', '.edit-unit-act', function(){
        var id = $(this).data('id');
        $.ajax({
...
<?php }elseif($url_cek == 'master/tipe/'){ ?>
    ...
    $(document).on('click', '.del-tipe', function(){
        var id = $(this).data('id');
    ...
    $(document).on('click', '.edit-tipe-act', function(){
        var id = $(this).data('id');
        var status = $(this).data('status');
            $.ajax({
...
<?php }elseif($url_cek == 'master/view_max/'){ ?>
    <script>
        ...
        $(document).on('click', '.set_edit_max', function(){
    ...
    $(document).on('click', '.del-max', function(){
        var id_max = $(this).data('id_max');
...
<?php }elseif($url_cek == 'marketing/transaksi_bank/'){ ?>
    <script>
        ...
        $('#filter').change(function(){
            ...
            if(filter == 0){
                document.location.href = '<?= site_url('marketing/transaksi_bank'); ?>';
            } else {
                document.location.href = '<?= site_url('marketing/transaksi_bank?filter='); ?>'+filter;
            }
        });
        ...
        $('#add-transaksi-bank').on('click', function(){
            $('#add-transaksi-bank').attr('disabled', true);

            $('#add-transaksi-bank').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
            ...
            $.ajax({
                ...
                success : function(result){
                    if(result.success == true) {
                        ...
                        $('#add-transaksi-bank').removeAttr('disabled');
                        $('#add-transaksi-bank').html('Save');
                        if(result.status == 1) {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Oops...',
        ...
        $(document).on('click','.view-tf-bank', function(){
            ...
            $('#tf-bnk').html('<div class="text-center"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></div>');
        ...
        $('.btn-save-edit').on('click', function(){
            ...
            $('.btn-save-edit').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
            //Data Konsumen
        ...
        function loading_animation(){
            $('#load_calon_konsumen').html('<div class="text-center"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></div>');
        }

        function load_calon_konsumen(){

            const type = 1;
            $.ajax({
                url: '<?= site_url('marketing/show_data_konsumen'); ?>',
                data: {type: type},
                type: 'POST',
                success: function(d){
                    $('#load_calon_konsumen').html(d);
                }
            });
        }
...
<?php }elseif($url_cek == 'marketing/transaksi_inhouse/'){ ?>
    <script>
        ...
        $('#filter').change(function(){
            ...
            if(filter == 0){
                document.location.href = '<?= site_url('marketing/transaksi_inhouse'); ?>';
            } else {
                document.location.href = '<?= site_url('marketing/transaksi_inhouse?filter='); ?>'+filter;
            }
        });
        ...
        $(document).on('click','.viewdetailinhouse', function(){
            ...
            $('#detailTransaksiInhouse').html('<div class="text-center"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></div>');
...
<?php }elseif($url_cek == 'marketing/konsumen/'){ ?>
    ...
    $('#filter').change(function(){
            ...
            if(filter == 0){
                document.location.href = '<?= site_url('marketing/konsumen'); ?>';
            } else {
                document.location.href = '<?= site_url('marketing/konsumen?filter='); ?>'+filter;
            }
    });
    ...
    $('#table-konsumen').dataTable();
        ...
        $(document).on('click', '.bukti-spr', function(){
            ...
            $('.bukti-spr-show').html('<div class="text-center"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></div>');
        ...
        $(document).on('keyup mouseup','#nominal', function() {
            $("#nominal").inputmask({
                radixPoint: ',',
                groupSeparator: ".",
                alias: "numeric",
        ...
        $('#onsubmitcashback').submit(function(){
            delete_mask_nominal();
        })

        function delete_mask_nominal(){
            $("#nominal").inputmask({
                radixPoint: ',',
                groupSeparator: ".",
                alias: "numeric"
...
<?php }elseif($url_cek == 'marketing/transaksi_batal/'){ ?>
    <script>
        ...
        $('#filter').change(function(){
            ...
            if(filter == 0){
                document.location.href = '<?= site_url('marketing/transaksi_batal'); ?>';
            } else {
                document.location.href = '<?= site_url('marketing/transaksi_batal?filter='); ?>'+filter;
            }
        });
...
<?php }elseif($url_cek == 'kpr/konsumen/'){ ?>
    ...
    $(document).on('click', '.rejec-konsumen',function(d){
        d.preventDefault();
    ...
    $(document).on('click', '.fee-marketing', function(){
        var id = $(this).data('id');
...
<?php }elseif($url_cek == 'accounting/fee_marketing/'){ ?>
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approve_fee_marketing_manager/'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
...
<?php } elseif($url_cek == 'accounting/pembangunan/'){ ?>
    ...
    <script>
        ...
        $(document).on('click','.addCicil', function(){
            ...
            $.ajax({
                url: '<?= site_url('accounting/show_mandor_proyek'); ?>',
                data: {id: id},
                type: 'POST',
                success: function(d){
                    $('#showMandor').html(d);
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approve_pembangunan_manager/'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
    ...
    $('#toFilter').click(function(){
        ...
        $('#toFilter').attr('disabled', true);
        window.location.href = '<?= site_url('accounting/pembangunan?tgl_a=') ?>' + tgl_a + '&tgl_b=' + tgl_b;
    });
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '.show_detail', function(){
                $('#modalDetail').modal('show');
                let id = $(this).data('id');
                let dateA = $(this).data('tgla');
                let dateB = $(this).data('tglb');

                

                $.ajax({
                    url: '<?= site_url('accounting/show_detail_laporan') ?>',
                    data: {
                        id: id,
                        date_A: dateA,
                        date_B: dateB
...
<?php } elseif($url_cek == 'accounting/insidentil/'){ ?>
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approveInsidentilManager'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
...
<?php } elseif($url_cek == 'accounting/pengajuan_material/'){ ?>
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approveMaterialManager'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
    ...
    $('#toFilter').click(function(){
        ...
        window.location.href = '<?= site_url('accounting/pengajuan_material?date_a='); ?>' + date_a + '&date_b=' + date_b;
    });
...
<?php } elseif($url_cek == 'accounting/pembatalan_transaksi/'){ ?>
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approveBatalManager'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
...
<?php } elseif($url_cek == 'accounting/kas_operasional/'){ ?>
    ...
    <script>
        ...
        $(document).on('click','.approve-mngr', function(){
            let id = $(this).data('id');
            $.ajax({
                url: '<?= site_url('accounting/set_status_kas') ?>',
    ...
    $('#to_go').click(function(){
        let dateA = $('#date_a').val();
        let dateB = $('#date_b').val();

        window.location.href = '<?= site_url('accounting/kas_operasional?date_a=') ?>'+dateA+ '&date_b=' + dateB;
    });
    ...
    $('#filter_kode').change(function(){
        let val = $(this).val();
        if(val == ''){
            window.location.href = '<?= site_url('accounting/kas_operasional') ?>';
        } else {
            window.location.href = '<?= site_url('accounting/kas_operasional?code=') ?>' + val;
        }
    });
    ...
    $(document).on('click','.apprv-mngr', function(){
        let id = $(this).data('id');
        $.ajax({
            url: '<?= site_url('accounting/approveKasMngr'); ?>',
            data: {id: id},
            type: 'POST',
            dataType: 'JSON',
            success: function(d){
...
<?php } elseif($url_cek == 'accounting/pemasukan_lain/'){ ?>
    ...
    <script>
        ...
        $(document).on('click','.approve-mngr', function(){
            let id = $(this).data('id');
            $.ajax({
                url: '<?= site_url('accounting/approve_pemasukan_lain_manager') ?>',
                data: {id: id},
                type: 'POST',
                dataType: 'JSON',
                success: function(d){
