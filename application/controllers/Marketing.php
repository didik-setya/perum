...
class Marketing extends CI_Controller {
    ...
    public function data_konsumen(){
        ...
        if($this->session->userdata('group_id') == 4){
            ...
            $data['calon_konsumen'] = $this->db->order_by('nama_konsumen','ASC')->get_where('tbl_marketing',['status' => 1, 'perum' => $this->session->userdata('id_perumahan'), 'admin_id' => $user])->result();
        } else {

            if(isset($_GET['filter'])){
                $data['calon_konsumen'] = $this->db->order_by('nama_konsumen','ASC')->get_where('tbl_marketing',['status' => 1, 'perum' => $this->session->userdata('id_perumahan'), 'admin_id' => $_GET['filter']])->result();
            } else {
            ...
            $data['marketing'] = $this->master_model->get_marketing()->result();
    ...
    public function transaksi_bank(){
        ...
        if($this->session->userdata('group_id') == 1 || $this->session->userdata('group_id') == 14){
            ...
            if(isset($_GET['filter'])){
                $filter = $_GET['filter'];
                $q = "SELECT * FROM tbl_transaksi_bank, tbl_marketing, tbl_kavling WHERE tbl_transaksi_bank.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_bank.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 3 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $filter";
            } else {
            ...
            $data['calon_konsumen'] = $this->db->get_where('tbl_marketing',['status' => 1 ,'perum' => $this->session->userdata('id_perumahan'), 'admin_id' => $user_id])->result();
        }

        $data['konsumen_tf_bank'] = $this->db->query($q)->result();
        $data['kavling'] = $this->master_model->get_kavling_join_perums($id_perumahan);
    ...
    public function transaksi_inhouse(){
        ...
        if($this->session->userdata('group_id') == 1 || $this->session->userdata('group_id') == 14){
            ...
            if(isset($_GET['filter'])){
                $filter = $_GET['filter'];
                $q = "SELECT * FROM tbl_transaksi_inhouse, tbl_marketing, tbl_kavling WHERE tbl_transaksi_inhouse.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_inhouse.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 2 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $filter";
            } else {
            ...
            $data['konsumen_tf_bank'] = $this->db->get_where('tbl_marketing',['status' => 1, 'perum' => $this->session->userdata('id_perumahan'), 'admin_id' => $user_id])->result();
        }
    ...
    public function konsumen(){
        ...
        if($this->session->userdata('group_id') == 1 || $this->session->userdata('group_id') == 14){
            ...
            if(isset($_GET['filter'])){
                $filter = $_GET['filter'];
                $q = "SELECT * FROM tbl_transaksi_bank, tbl_marketing, tbl_kavling WHERE tbl_transaksi_bank.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_bank.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $filter";
            
                $p = "SELECT * FROM tbl_transaksi_inhouse, tbl_marketing, tbl_kavling WHERE tbl_transaksi_inhouse.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_inhouse.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $filter";
            } else {
            ...
            $q = "SELECT * FROM tbl_transaksi_bank, tbl_marketing, tbl_kavling WHERE tbl_transaksi_bank.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_bank.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $user_id";

            $data['bank'] = $this->db->query($q)->result();

            $p = "SELECT * FROM tbl_transaksi_inhouse, tbl_marketing, tbl_kavling WHERE tbl_transaksi_inhouse.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_inhouse.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status != 0 AND tbl_marketing.status != 1 AND tbl_marketing.admin_id = $user_id";
    ...
    public function batal_transaksi_bank(){
        ...
        $this->db->set('status',0)->set('update_at', date('Y-m-d'))->where('id_marketing', $id)->update('tbl_marketing');
    ...
    public function transaksi_batal(){
        ...
        if($this->session->userdata('group_id') == 1 || $this->session->userdata('group_id') == 14){
            ...
            if(isset($_GET['filter'])){
                $filter = $_GET['filter'];
                $q = "SELECT * FROM tbl_transaksi_bank, tbl_marketing, tbl_kavling WHERE tbl_transaksi_bank.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_bank.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status = 0 AND tbl_marketing.admin_id = $filter";

                $p = "SELECT * FROM tbl_transaksi_inhouse, tbl_marketing, tbl_kavling WHERE tbl_transaksi_inhouse.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_inhouse.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status = 0 AND tbl_marketing.admin_id = $filter";
            } else {
            ...
            $q = "SELECT * FROM tbl_transaksi_bank, tbl_marketing, tbl_kavling WHERE tbl_transaksi_bank.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_bank.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status = 0 AND tbl_marketing.admin_id = $user";

            $data['bank'] = $this->db->query($q)->result();

            $p = "SELECT * FROM tbl_transaksi_inhouse, tbl_marketing, tbl_kavling WHERE tbl_transaksi_inhouse.id_rumah = tbl_kavling.id_kavling AND tbl_transaksi_inhouse.id_konsumen = tbl_marketing.id_marketing AND tbl_kavling.id_perum = $id_perumahan AND tbl_marketing.status = 0 AND tbl_marketing.admin_id = $user";
    ...
    public function show_data_konsumen(){
        ...
        if($type == 1){
            ...
            $this->load->view('ajax/list_konsumen', $data);
